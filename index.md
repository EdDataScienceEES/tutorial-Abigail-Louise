...
- Visualise the data and results
- Report findings
...
Refer to part 1 - <a href="https://ourcodingclub.github.io/tutorials/anova/">ANOVA from A to (XY)Z</a> for a more in depth explanation of ANOVA or if you are unsure you have chosen the appropriate test for your data.
...
Lastly, let's improve our Tukey's multiple comparison plot from earlier:
